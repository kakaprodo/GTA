...
export class FournMvm extends Query{
    constructor(BindView=[],keyName='id'){
      ...
      this.agent=null;
      this.colQuery="motif,montant,is_paid,fss_id,created_at";
      /*col to send fro creating the table client for the first time*/
      this.colCreation="id integer primary key not null,motif text,montant text,is_paid integer,fss_id text,created_at text";
    ...
    conf(){
     ...
     super.tab("fss_mvm",this.colCreation).newTable(()=>{
    ...
    fss_mvm(id,index=undefined,onSucc,onErr){
       super.keyValue(id).belongsTo("fournisseur","fss_id",(allMvm)=>{
